package net.mcreator.bestsuperheromod.client.model;
...
public class ModelGREENARROW<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("best_superhero_mod", "model_greenarrow"),
			"main");
	...
	public ModelGREENARROW(ModelPart root) {
