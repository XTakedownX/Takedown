...
import net.mcreator.bestsuperheromod.client.model.Modelcustom_model;

import java.util.function.Consumer;
import java.util.Map;
import java.util.Collections;

public abstract class NightwingItem extends ArmorItem {
	public NightwingItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends NightwingItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "best_superhero_mod:textures/entities/batman_beyond_layer1.png";
		}
	}

	public static class Chestplate extends NightwingItem {
		public Chestplate() {
	...
	public static class Leggings extends NightwingItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "best_superhero_mod:textures/entities/batman_beyond_layer2.png";
		}
	}

	public static class Boots extends NightwingItem {
		public Boots() {
