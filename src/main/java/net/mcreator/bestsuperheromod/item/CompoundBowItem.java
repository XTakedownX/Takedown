...
public class CompoundBowItem extends Item {
	public CompoundBowItem() {
		super(new Item.Properties().tab(BestSuperheroModModTabs.TAB_COLLECTIVE_HEROES).durability(100));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					CompoundBowEntity entityarrow = CompoundBowEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
